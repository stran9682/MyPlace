    ...
    constructor() {
        ...
        try {
            ...
            this.conn = new HubConnectionBuilder()
                .withUrl(header, {
                    accessTokenFactory: () => {
                        return "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJodHRwOi8vc2NoZW1hcy54bWxzb2FwLm9yZy93cy8yMDA1LzA1L2lkZW50aXR5L2NsYWltcy9uYW1lIjoic3RyaW5nQHN0cmluZy5jb20iLCJleHAiOjE3NjA5NzYyNDIsImlzcyI6Iklzc3VlciIsImF1ZCI6IkF1ZGllbmNlIn0.FYqkVRgvuM48vFYd7UewUVgLYFbWkKDlpW1i9gZ7DgQ"
                    }
                })
